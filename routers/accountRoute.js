...
//router.route("/resendOtp/:email").get(accountController.resendOtp);
...
router
  .route("/likedEvent/:eventId/:accountId")
  .patch(accountController.eventLiked);

router
  .route("/getlikedEventIds/:accId")
  .get(accountController.getAccountEventIds);

router
  .route("/getAccountByMail/:email")
  .get(accountController.getAccountByEmail);
